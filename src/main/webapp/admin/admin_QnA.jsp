...
<html style="font-size: 16px;" lang="en"><head>
  ...
  <title>admin_QnA</title>
  <link rel="stylesheet" href="nicepage.css" media="screen">
  <link rel="stylesheet" href="admin_QnA.css" media="screen">
  ...
  <script>
    $(document).on('click', '.updateBtn', function () {
      ...
      if (img != '' && img != null) {
        ...
        $("#img").attr("src", "images/f8343086770128586d092cbd3eb69339ae7a6fbae365335cf23f48993ac7fed6e761c0bb421b6562cb65abedd50b6331a005d02183ab3925e18bb8_1280.png");
      }
      $("#cs_id").val(cs_id);
      $("#s_type").val(s_type);
      $("#title").val(title);
      $("#content").val(content);
      $("#reply").val(reply);
      $("#deleteLink").attr("href","../admin/delete_QnA.do?cs_id="+cs_id);
      $("#carousel_92e1").addClass("u-dialog-open");
    });
  </script>
  ...
  <meta property="og:title" content="admin_QnA">
                      ...
                      <c:if test="${s.index>=0 && s.index<10 }">
                        <div class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-5-light-1 u-container-style u-group u-shape-rectangle u-group-6">
                          <div class="u-container-layout u-container-layout-8">
                            <a data-cs_id="${list.cs_id}" data-s_type="${list.s_type}" data-content="${list.content}" data-title="${list.title}"  data-img="${list.img}"  data-reply="${list.reply}"     class="updateBtn u-active-white u-align-left u-border-none u-btn u-button-style u-hover-white u-text-active-black u-text-black u-text-hover-black u-white u-btn-3">${list.title}</a>
                          </div>
                        </div>
                      </c:if>
                    </c:forEach>
                      ...
                      <ul class="pagination" style="margin-bottom: 199px;">
                        <li class="page-item">
                          <c:if test="${startPage > 1 }">
                            <a class="page-link"
                               href="../admin/admin_QnA.do?page=${startPage-1 }"
                               aria-label="Previous">
                        ...
                        <c:forEach var="i" begin="${startPage }" end="${endPage }">
                          ...
                          <li ${style } ><a
                                  href="../admin/admin_QnA.do?page=${i}">${i }</a>
                          </li>
                        </c:forEach>
                        <li class="page-item">
                          ...
                          <c:if test="${endPage < totalpage }">
                            <a class="page-link"
                               href="../admin/admin_QnA.do?page=${endPage+1 }"
                               aria-label="Next">
...
<section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-dialog-section-13" id="carousel_92e1">
  <div class="u-container-style u-dialog u-white u-dialog-1">
    <div class="u-container-layout u-valign-bottom u-container-layout-1">
      <img id="img" class="u-image u-image-default u-image-1"
           ...
           alt="" data-image-width="150" data-image-height="100" style="height: 189px;width: 176px;">

      <div class="u-expanded-width u-form u-form-1">
        <form id="qnaForm" action="../admin/save_QnA.do" method="POST" style="padding: 15px;">
          <div class="u-form-group u-form-name u-form-partition-factor-2">
            <input id="cs_id" name="cs_id" type="hidden">
            <label for="name-e29c" class="u-label">문의유형</label>
            <input disabled="disabled" type="text" id="s_type"   class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" maxlength="100">
          </div>
          <div class="u-form-group u-form-partition-factor-2 u-form-group-2">
            <label for="phone-6f41" class="u-label">제목</label>
            <input disabled="disabled" type="text" id="title"   class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" maxlength="20" required="required">
          </div>
          <div class="u-form-group u-form-textarea u-form-group-3">
            <label for="textarea-2410" class="u-label">문의내용</label>
            <textarea disabled="disabled" rows="5" id="content" cols="50" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" maxlength="2000" placeholder="내용 입력"></textarea>
          </div>
          <div class="u-form-group u-form-textarea u-form-group-4">
            <label for="reply" class="u-label">문의답변</label>
            <textarea rows="5" cols="50" id="reply" name="content" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" placeholder="답변달기"></textarea>
          </div>
          <div class="u-align-right u-form-group ">
            <input type="submit" class="u-border-2 u-border-hover-palette-1-base u-border-palette-1-base  u-button-style u-hover-palette-1-base u-none u-btn-2" value="저장">
            <a id="deleteLink" href="" class="u-border-2 u-border-hover-palette-1-base u-border-palette-1-base u-btn u-button-style u-hover-palette-1-base u-none u-btn-3">삭제</a>
