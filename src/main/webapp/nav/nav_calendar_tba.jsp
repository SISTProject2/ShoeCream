   		...
   		<c:if test="${s.index>=0 && s.index<10 }"> 
	         <div class="u-container-style u-list-item u-repeater-item">     
	           <div class="u-container-layout u-similar-container u-container-layout-1">
	             ...
	             <h4 class="u-custom-item	u-text u-text-default u-text-1" font-weight: bold;>TBA</h4>
	             <h1 class="u-custom-item u-text u-text-default u-text-2"> </h1>
	             <h1 class="u-custom-item u-text u-text-default u-text-2"> </h1>
	             <h1 class="u-custom-item u-text u-text-default u-text-2"> </h1>
     	...
     	<nav aria-label="Page navigation example">
		  <ul class="pagination">
		    <li class="page-item">
		      ...
		      <a class="page-link" href="../nav/nav_calendar_tba.do?regdate=${regdate }&page=${startPage-1 }" aria-label="Previous">
		    ...
		    <c:forEach var="i" begin="${startPage }" end="${endPage }">            
	            ...
	            <li ${style }><a href="../nav/nav_calendar_tba.do?=${regdate }&page=${i }">${i }</a></li>
	       </c:forEach>

		    <li class="page-item">
		    
		      <c:if test="${endPage < totalpage }">
		      <a class="page-link" href="../nav/nav_calendar_tba.do?=${regdate }&page=${endPage+1 }" aria-label="Next">
