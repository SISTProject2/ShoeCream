...
<script type="application/ld+json">{
  ...
  <body class="u-body u-xl-mode" data-lang="en">
    <section class="u-clearfix u-section-1" id="sec-aa34">
      <img class="u-expanded-width u-image u-image-default u-image-1" style="margin-top:120px;" src="../home/nav_men/images/new.png" alt="" data-image-width="694" data-image-height="324">
      ...
      <div class="container" style="margin-top: 250px">
	 	 <a href="../nav/nav_new.do?no=1"><img src="../images/pop.png" width="108px" height="38px"></a> 
	 	 <a href="../nav/nav_new.do?no=2"><img src="../images/high.png" width="108px" height="38px"></a> 
	 	 <a href="../nav/nav_new.do?no=3"><img src="../images/low.png" width="108px" height="38px"></a> 
        ...
        <c:if test="${s.index>=0 && s.index<12 }">
		  ...
		  <ul class="pagination">
		    <li class="page-item">
		      ...
		      <a class="page-link" href="../nav/nav_new.do?no=${no }&page=${startPage-1 } aria-label="Previous">
		    ...
		    <c:forEach var="i" begin="${startPage }" end="${endPage }">            
	            ...
	            <li ${style }><a href="../nav/nav_new.do?no=${no }&page=${i }">${i }</a></li>
	       </c:forEach>

		    <li class="page-item">
		    
		      <c:if test="${endPage < totalpage }">
		      <a class="page-link" href="../nav/nav_new.do?no=${no }&page=${endPage+1 }" aria-label="Next">
