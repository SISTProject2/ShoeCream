...
<script type="application/ld+json">{
  ...
  <body class="u-body u-xl-mode" data-lang="en">
    <section class="u-clearfix u-section-1" id="sec-aa34">
      <img class="u-expanded-width u-image u-image-default u-image-1" style="margin-top:120px;" src="../home/nav_men/images/men.jpg" alt="" data-image-width="694" data-image-height="324">
      ...
      <h2 class="u-text u-text-default u-text-2" style="position: relative; top: 40px">MEN</h2>
