...
<script type="application/ld+json">{
  ...
  <body class="u-body u-xl-mode" data-lang="en">
    <section class="u-clearfix u-section-1" id="sec-aa34">
      <img class="u-expanded-width u-image u-image-default u-image-1" style="margin-top:110px;" src="../home/nav_men/images/women.png" alt="" data-image-width="694" data-image-height="324">

      
      <h2 class="u-text u-text-default u-text-2" style="position: relative; top: 40px"></h2>
      
      <!-- 신발 종류 -->
	    <div class="u-list u-list-199" style="margin: 0 auto">
      ...
      <div class="container" style="margin-top: 250px">
	 	 <a href="../nav/nav_women.do?no=1"><button type="button" class="btn btn-outline-dark" style="color: black">인기 순</button></a> 
	 	 <a href="../nav/nav_women.do?no=2"><button type="button" class="btn btn-outline-dark" style="color: black">높은 가격 순</button></a> 
	 	 <a href="../nav/nav_women.do?no=3"><button type="button" class="btn btn-outline-dark" style="color: black">낮은 가격 순</button></a> 
	 	 <a href="../nav/nav_women.do?no=4"><button type="button" class="btn btn-outline-dark" style="color: black">최신 발매 순</button></a> 
	 	 <a href="../nav/nav_women.do?no=5&no=5"><button type="button" class="btn btn-outline-dark" style="color: black">오래된 발매 순</button></a>
      ...
      <nav aria-label="Page navigation example">
		  <ul class="pagination">
		    <li class="page-item">
		      ...
		      <a class="page-link" href="../nav/nav_women.do?no=${no }&page=${startPage-1 }" aria-label="Previous">
		    ...
		    <c:forEach var="i" begin="${startPage }" end="${endPage }">            
	            ...
	            <li ${style }><a href="../nav/nav_women.do?no=${no }&page=${i }">${i }</a></li>
	       </c:forEach>

		    <li class="page-item">
		    
		      <c:if test="${endPage < totalpage }">
		      <a class="page-link" href="../nav/nav_women.do?no=${no }&page=${endPage+1 }" aria-label="Next">
