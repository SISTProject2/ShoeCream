		  ...
		  $.fn.customFile = function() {
		    ...
		    return this.each(function() {
		      ...
		      var $file = $(this).addClass('custom-file-upload-hidden'), // the original file input
		          ...
		          $input = $('<input type="text" placeholder="파일" id="name-558c" name="name" class="file-upload-input" style="height: 10px; font-size: 0.875rem; border:1px solid #c0c0c0; width: 154px; margin-left:0px; margin-top: -6px;" required=""/>'),
