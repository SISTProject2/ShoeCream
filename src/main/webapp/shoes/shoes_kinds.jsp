  ...
  <body class="u-body u-xl-mode" data-lang="en">
    <section class="u-clearfix u-section-1" id="sec-aa34" style="bottom: 10% ">
      ...
      <div class="container" style="margin-top: 250px">
	 	 <a href="../shoes/shoes_kinds.do?category_id=${category_id }&no=1"><img src="../images/pop.png" width="108px" height="38px"></a> 
	 	 <a href="../shoes/shoes_kinds.do?category_id=${category_id }&no=2"><img src="../images/high.png" width="108px" height="38px"></a> 
	 	 <a href="../shoes/shoes_kinds.do?category_id=${category_id }&no=3"><img src="../images/low.png" width="108px" height="38px"></a> 
	 	 <a href="../shoes/shoes_kinds.do?category_id=${category_id }&no=4"><img src="../images/latest.png" width="108px" height="38px"></a> 
	 	 <a href="../shoes/shoes_kinds.do?category_id=${category_id }&no=5"><img src="../images/old.png" width="108px" height="38px"></a>
