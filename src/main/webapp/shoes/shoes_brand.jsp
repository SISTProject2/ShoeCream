  ...
  <body class="u-body u-xl-mode" data-lang="en">
    <section class="u-clearfix u-section-1" id="sec-aa34">
      ...
      <div class="container" style="margin-top: 250px">
	 	 ...
	 	 <a href="../shoes/shoes_brand.do?brand=${brand }&no=4"><img src="../images/latest.png" width="108px" height="38px"></a> 
	 	 <a href="../shoes/shoes_brand.do?brand=${brand }&no=5"><img src="../images/old.png" width="108px" height="38px"></a>
